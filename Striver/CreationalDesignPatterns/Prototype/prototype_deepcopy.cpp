...
class WelcomeEmail:public EmailTemplate{
    ...
    EmailTemplate*clone() override{//Copy constructor — sirf values copy karta hai, koi DB/file call nahi
        ...
        clonedobject->priority = new int(*priority);  
        cout << "[WelcomeEmail] Cloned successfully\n";
        cout << "[Cloned] priority address: " << clonedobject->priority<< " DIFFERENT from original!\n";
        return clonedobject;
    }
...
// Yeh...
// WelcomeEmail* clonedObject = new WelcomeEmail(*this);

// // ...internally yeh karta hai:
// WelcomeEmail(const WelcomeEmail& other) {
//     subject    = other.subject;
//     content    = other.content;
//     htmlLayout = other.htmlLayout;
//     fontConfig = other.fontConfig;
// }
// bas other = *this hai yahan